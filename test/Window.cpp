...
#define WINDOW_HEIGHT 240	// ウィンドウの高さ
...
HRESULT InitD3D(HWND hWnd) {
	...
	sd.BufferDesc.Format = DXGI_FORMAT_B8G8R8A8_UNORM;	// バッファのフォーマット
